...
function CartDetail({ cartCount, setCartCount }) {
  const { user } = useAuth();
              ...
              cartCount.map((cart) => (
                <Box className="cart-item" key={cart?.productId?._id}>
                  <Box className="cart-product">
                    ...
                    <Box>
                      <Typography fontWeight={500} ml={0.5} fontSize={18}>
                  ...
                  <Box className="cart-product-total-price">
                    $ {cart?.productId?.priceSale * cart?.amount}
                  </Box>
                </Box>
              ))}
          </Box>
